/**
 * Main header file to small-faster sketchs for Arduino IDE
 * version 2.0 for ATmega2560 & etc. (avr6), Atmega328p & etc. CPU
 *
 * Wiring++: Библиотека для уменьшения размеров скетчей и улучшения их работы
 *
 * @author Arhat109-20160501(started). arhat109@mail.ru
 * @license:
 *   1. This is a free software for any using and distributing without any warranties.
 *   2. You should keep author tag with any changes. Your own may be adding too.
...
// ============= main defines constants for Arduing ============ //
